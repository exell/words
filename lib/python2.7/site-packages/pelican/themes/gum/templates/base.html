...
<script src="{{ SITEURL }}/tipuedrop/tipuedrop_content.js"></script>
<link href="{{ SITEURL }}/tipuedrop/tipuedrop.css" rel="stylesheet">
<script src="{{ SITEURL }}/tipuedrop/tipuedrop.js"></script>
